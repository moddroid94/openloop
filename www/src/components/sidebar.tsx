        ...
        <aside id="default-sidebar" className="dark fixed left-0 w-1/5 h-screen transition-transform -translate-x-full sm:translate-x-0 shadow-lg border-r-[0.5px] border-gray-600 z-40" aria-label="Sidebar" aria-hidden="true">
            <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-900 pt-20">
                <ul className="space-y-2 font-medium">
                    <li >
                        <a href="/" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 bg-gray-900 group grayscale pointer-events-none">
                    ...
                    <li>
                        <a href="/samples" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <a href="/packs/" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 bg-gray-900 group grayscale pointer-events-none" >
