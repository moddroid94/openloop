export default function Sidebar() {
    return (
        <aside id="default-sidebar" className="dark fixed left-0 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 shadow-lg border-r-[0.5px] border-gray-600 z-50" aria-label="Sidebar" aria-hidden="true">
